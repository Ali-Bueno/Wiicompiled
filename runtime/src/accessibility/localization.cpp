...
constexpr Phrase kEnglishDefaults[] = {
    ...
    // Spoken once at startup when the background update check finds a newer release.
    // The "_manual" pair is used when no installer path is recorded, so there is
    // nothing to offer to run.
    {"update_mod",
     "A new Mario Kart Wii Access version is available. Press Enter to update now, or "
     "Escape to keep playing."},
    {"update_retro_rewind",
     "A new Retro Rewind version is available. Press Enter to update now, or Escape to "
     "keep playing."},
    {"update_mod_manual",
     "A new Mario Kart Wii Access version is available. Run the installer in your game "
     "folder to update."},
    {"update_retro_rewind_manual",
     "A new Retro Rewind version is available. Run the installer in your game folder to "
     "update it before playing online."},
    {"update_declined", "Continuing without updating."},
    {"update_starting", "Starting the updater. The game will close now."},
    {"update_failed", "The updater could not be started."},
    ...
    {"opt_edge_cue_volume", "edge cue volume"},
    {"opt_surface_cue_volume", "surface cue volume"},
    {"opt_curve_cue_volume", "curve cue volume"},
    {"opt_countdown_cue_volume", "countdown cue volume"},
    {"opt_item_box_cue_volume", "item box cue volume"},
    {"opt_invert_pan", "invert steering pan"},
    {"opt_steering_strength", "steering guide strength"},
    {"opt_look_ahead", "anticipation"},
    {"opt_steering_lean_angle", "steering lean angle"},
    ...
    {"opt_roulette_volume_help",
     ...
     "alone."},
    {"opt_edge_cue_volume_help",
     "The beeps near the edge of the road and the held tone while off it. Every step plays the tone at the new level."},
    {"opt_surface_cue_volume_help",
     "The note when the kart leaves the road and the one when it comes back. Every step plays it."},
    {"opt_curve_cue_volume_help",
     "The beeps that mark a corner's entry, apex and exit. Every step plays one."},
    {"opt_countdown_cue_volume_help",
     "The three rising beeps that count a corner in. Every step plays one."},
    {"opt_item_box_cue_volume_help",
     "The blip that points at a nearby item box while your hands are empty. Every step plays it."},
    {"opt_steering_strength_help",
     "How hard the engine pans when the kart points away from the racing line. Raise it for a wider, more obvious swing, lower it for a subtler one."},
    {"opt_look_ahead_help",
     "How far ahead in time the mod looks: a tenth of a second at zero, the play-tested eight tenths at one hundred, about a second and a half at two hundred. Raise it to be warned of corners and of the road edge earlier, lower it to follow what is happening right now."},
    {"opt_steering_lean_angle_help",
     "How far off the racing line the kart has to point before the engine is at its widest pan. Lower it and the engine swings wider for the same corner; raise it for a softer, more gradual lean."},
    {"opt_invert_pan_help",
